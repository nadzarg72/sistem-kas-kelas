...
<body>
    ...
    <div class="auth-page">
        ...
        <div class="glass-card-login animate-entry delay-1">
            <h1 class="auth-brand">JOIN <span style="color: var(--brand-orange);">CLASS</span></h1>
            <p class="auth-desc">Buat akun baru sekarang.</p>
            ...
            <div class="auth-footer-link">
                <p>Sudah punya akun? <a href="login.php" style="color: var(--brand-orange);">Login disini</a></p>
                <br>
