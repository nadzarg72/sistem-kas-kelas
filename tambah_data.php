...
<head>
    ...
    <style>
        ...
        * { margin: 0; padding: 0; box-sizing: border-box; font-family: 'Poppins', sans-serif; }
        ...
        .card-header h2 { font-size: 1.5rem; font-weight: 600; color: #fff; letter-spacing: 0.5px; }
        ...
        .radio-label {
            flex: 1; text-align: center; padding: 10px; cursor: pointer; border-radius: 8px; transition: 0.3s;
            font-weight: 500; font-size: 0.9rem; color: #94a3b8;
        }
        .radio-input { display: none; }
        
        /* Logic Radio Button Active Style */
        .radio-input:checked + .radio-label { color: #fff; font-weight: 600; box-shadow: 0 4px 6px rgba(0,0,0,0.1); }
        .radio-input[value="Masuk"]:checked + .radio-label { background: #16a34a; } /* Hijau */
        .radio-input[value="Keluar"]:checked + .radio-label { background: #dc2626; } /* Merah */
        ...
        .btn-save:hover { transform: translateY(-2px); box-shadow: 0 10px 20px -5px rgba(249, 115, 22, 0.4); }
        
        .btn-back {
            padding: 12px 25px;
            background: transparent;
            color: #94a3b8; border: 1px solid rgba(255,255,255,0.2);
            border-radius: 10px; text-decoration: none; font-weight: 500; transition: 0.3s;
            display: flex; align-items: center; gap: 8px;
        }
        ...
        .float-back {
            ...
            border: 1px solid rgba(255,255,255,0.1); transition: 0.3s; z-index: 10;
        }
        ...
        <div class="glass-card">
            <div class="card-header">
                <div>
                    ...
                    <p>Catat arus kas masuk atau keluar dengan detail.</p>
                </div>
                ...
                <form action="proses/tambah_transaksi.php" method="POST">
                    <div class="form-grid">
                        ...
                        <div>
                            <div class="input-wrapper">
                                ...
                                <div class="radio-group">
                                    <input type="radio" id="masuk" name="jenis" value="Masuk" class="radio-input" checked>
                                    <label for="masuk" class="radio-label"><i class="fas fa-arrow-down"></i> Pemasukan</label>
                                    
                                    <input type="radio" id="keluar" name="jenis" value="Keluar" class="radio-input">
                            ...
                            <div class="input-wrapper">
                                ...
                                <input type="date" name="tanggal" class="custom-input" required style="color-scheme: dark;">
                            </div>

                            <div class="input-wrapper">
                                <label class="input-label">Nominal (Rp)</label>
                                <input type="number" name="nominal" class="custom-input" placeholder="0" style="font-size: 1.1rem; font-weight: bold; color: #4ade80;" required>
                            </div>
                        </div>
                        ...
                        <div>
                            <div class="input-wrapper">
                                ...
                                <input type="text" name="pihak_terkait" class="custom-input" placeholder="Contoh: Siswa A, Toko ATK" required autocomplete="off">
                            </div>

                            <div class="input-wrapper">
                                <label class="input-label">Keterangan / Catatan</label>
                                <textarea name="keterangan" rows="5" class="custom-textarea" placeholder="Tulis detail transaksi disini (opsional)..."></textarea>
                            </div>
                        </div>
                    ...
                    <div class="btn-group">
                        ...
                        <button type="submit" class="btn-save">
                            Simpan Data <i class="fas fa-check-circle"></i>
                        </button>
                    </div>
                </form>
            </div>
